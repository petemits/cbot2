...
### 🧩 Core Components
- 6 class(es): AIParagraphGenerator, RealLeadScraperBot, RealLeadBot, RealWebScraper, LeadManager
- 49 function(s): fetchWithWinINET, extractPhones, generateParagraph, replaceAll, showStats
